...
Collection.wrap.save = function wrapSave ( collection ) {
  return function save ( fields, callback ) { collection.save(this, callback); return this; }
}
...
Collection.wrap.refresh = function wrapRefresh ( collection ) {
  return function refresh ( fields, callback ) { collection.refresh(this, callback); return this; }
}
